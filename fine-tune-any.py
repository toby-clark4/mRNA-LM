...
file_name = "icodon_zebrafish.csv"
tokenized_name = "zebrafish_codonbert"
sequence_column = "CDS"
target_column = "y"
...
data_path = f"../CDS-LM/data/finetuning/icodon"# {task}"
...
pd.DataFrame({'r': r_list, 'rho': rho_list}).to_csv(f'{res_dir}/{name}_test.csv')
